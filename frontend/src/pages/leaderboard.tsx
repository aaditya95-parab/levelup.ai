import { useGetLeaderboard } from "../lib/api-client-react";
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      <header className="text-center mb-12">
        ...
        >
          <Trophy className="w-20 h-20 mx-auto text-primary mb-6 drop-shadow-[0_0_20px_hsl(var(--primary)/0.4)]" />
        </motion.div>
                ...
                >
                  <div className="flex items-center gap-4 md:gap-8">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className={`text-xs font-display uppercase tracking-widest font-bold ${rank.color}`} style={{ textShadow: `0 0 6px ${rank.glowColor}` }}>
                          {rank.title}
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="flex-1 grid grid-cols-3 gap-4 items-center text-center md:text-right mt-2 md:mt-0 pt-4 md:pt-0 border-t md:border-t-0 border-white/5">
                    ...
                    <div className="flex flex-col md:items-end">
                      ...
                      <div className="text-2xl font-bold text-orange-500 flex items-center justify-center md:justify-end gap-1">
                        {player.streak > 0 && <Flame className="w-4 h-4 streak-flame" />}
                        {player.streak}
                      </div>
                    </div>
                    <div className="flex flex-col md:items-end">
                      <div className="text-[10px] text-muted-foreground font-display uppercase tracking-widest mb-1">Total XP</div>
                      <div className="text-xl font-bold text-secondary font-display tracking-wider flex items-center justify-center md:justify-end gap-1">
